 ...
 */
package org.iamc.vtn.cli.commands;
...
public class VtnCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(VtnCliTestCommand.class);
    protected final VtnCliCommands service;

    public VtnCliTestCommand(final VtnCliCommands service) {
